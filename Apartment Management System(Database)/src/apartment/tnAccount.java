 ...
 */
public class tnAccount extends JFrame {
    ...
    public void Account(String name, String password) {
        ...
        tnAccFrame.setTitle("Tenant Profile");
        ...
        JLabel mainLabel = new JLabel("Tenant Account");
        mainLabel.setBounds(210, 20, 210, 50);
        mainLabel.setFont(new Font("tahoma", Font.PLAIN, 25));
        tnAccFrame.add(mainLabel);

        JLabel lbl1 = new JLabel("Tenant Information :");
        lbl1.setBounds(20, 150, 150, 30);
        ...
        fb_lbl.setBounds(400, 250, 250, 20);
        ...
        try {
            ...
            ResultSet rs1 = st.executeQuery("select * from tenant,admin");
            int counter = 1;
            while (rs1.next()) {

                if (name.equals(rs1.getString("User_name")) && password.equals(rs1.getString("Passwords"))) {
                    ten_name = rs1.getString("Name");
                    ten_job = rs1.getString("Job");
                    ten_flatNo = rs1.getString("Flat_no");
                }
                if (counter <= 1) {
        ...
        JLabel lbl1b = new JLabel("Profession :  " + ten_job);
        lbl1b.setBounds(60, 200, 200, 30);
        lbl1b.setFont(f);
        tnAccFrame.add(lbl1b);
        JLabel lbl1c = new JLabel("Flat no :  " + ten_flatNo);
