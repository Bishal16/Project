...
public class tnLogin extends JFrame{
    ...
    public tnLogin() 
    {
        ...
        JLabel header=new JLabel("Tenant Login");
        ...
        JTextField userf = new JTextField("Bishal");
